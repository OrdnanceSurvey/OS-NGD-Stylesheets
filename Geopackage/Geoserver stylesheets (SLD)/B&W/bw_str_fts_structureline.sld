...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS NGD str_fts_structureline (Black and White)</Name>
    <UserStyle>
     ...
     <!--  Broken Feature  -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#D0D0D1</CssParameter>
                <CssParameter name="stroke-width">1.0</CssParameter>
                <CssParameter name="stroke-dasharray">1 1</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
...
<!--  Chair Lift  -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#C4C4C5</CssParameter>
                <CssParameter name="stroke-width">0.45</CssParameter>
                <CssParameter name="stroke-dasharray">5 2</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
  ...
  <!--  Culvert Entrance   -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#DEDEDF</CssParameter>
 ...
 <!--  Electricity Transmission Lines   -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#CECECF</CssParameter>
                <CssParameter name="stroke-width">0.45</CssParameter>
                <CssParameter name="stroke-dasharray">5 2</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
 ...
 <!--  Gantry   -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#BCBCBC</CssParameter>
                <CssParameter name="stroke-width">0.45</CssParameter>
                <CssParameter name="stroke-dasharray">5 2</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
 ...
 <!--  Pedestrian Tunnel Wall  -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#C5C5C6</CssParameter>
                <CssParameter name="stroke-width">0.3</CssParameter>
                <CssParameter name="stroke-dasharray">5 2</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
...
<!--  Rail Signal Gantry  -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Stroke>
                <CssParameter name="stroke">#B1B1B1</CssParameter>
                <CssParameter name="stroke-width">0.3</CssParameter>
                <CssParameter name="stroke-dasharray">5 2</CssParameter>
            </Stroke>
          </PolygonSymbolizer>
