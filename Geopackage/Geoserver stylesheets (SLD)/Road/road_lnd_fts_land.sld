...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <Name>OS NGD lnd_fts_land (Road)</Name>
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#FBFBF3</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
      </FeatureTypeStyle>    
              ...
              <GraphicFill>
                <Graphic>
                  <ExternalGraphic>
                    ...
                    xlink:href="os_ngd_symbols/fillBoulders_road.svg"/>
            ...
            <Fill>
              <GraphicFill>
                <Graphic>
                  <ExternalGraphic>
                    <OnlineResource xlink:type="simple"
                    xlink:href="os_ngd_symbols/fillMarsh_road.svg"/>
                    <Format>image/svg+xml</Format>
                  </ExternalGraphic>
                  <Size>60</Size>
                </Graphic>
            ...
            <Fill>
              <GraphicFill>
                <Graphic>
                  <ExternalGraphic>
                    <OnlineResource xlink:type="simple"
                    xlink:href="os_ngd_symbols/fillOrchard_road.svg"/>
                    <Format>image/svg+xml</Format>
                  </ExternalGraphic>
                  <Size>60</Size>
                </Graphic>
            ...
            <Fill>
              <GraphicFill>
                <Graphic>
                  <ExternalGraphic>
                    <OnlineResource xlink:type="simple"
                    xlink:href="os_ngd_symbols/fillScree_road.svg"/>
                    <Format>image/svg+xml</Format>
                  </ExternalGraphic>
                  <Size>60</Size>
                </Graphic>
...
<!--  Spreads -->
      <FeatureTypeStyle>
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#F6F7D2</CssParameter>
            </Fill>
          </PolygonSymbolizer>
        </Rule>
      </FeatureTypeStyle> 
